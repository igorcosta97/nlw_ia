    ...
    return(
        <form onSubmit={handleUploadVideo} className='space-y-6'>
            ...
            <div className='space-y-2'>
              ...
              <Textarea disabled={status != 'waiting'} ref={promptInputRef} id='transcription_prompt' className='h-24 resize-none leading-relaxed' placeholder='Inclua palavras-chave mencionadas no video separadas por virgula (,)'/>
            </div>
